...
def parse_titrations_arguments():
    ...
    parser.add_argument("--field_path", nargs='+', type=str, required=False, default=None, help="Path(s) to the extracellular field data file(s). Units should be in V for potential values and m for coordinates. If not provided, uses default example file from package.")
    ...
    parser.add_argument("--capacitive_stim_type", nargs='+', type=str, required=False, default=None, help="Type of capacitive stimulation ('flat-top' or 'exp-droop'). If provided, this should be the same number of values as the number of field files provided in --field_path.")
...
def parse_discrete_simulations_arguments():
    ...
    parser.add_argument("--time_step", type=float, required=False, default=None, help="Simulation time step")
    parser.add_argument("--pulse_path", nargs='+', type=str, required=False, default=None, help="Path(s) to the pulse waveform txt file(s) (Example: './examples/example_pulse.txt'). If provided, this should be the same number of files as the number of field files provided in --field_path.")
    parser.add_argument("--pulse_silence_period", nargs='+', type=float, required=False, default=None, help="Silence period(s) before the onset of the pulse. If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--pulse_shape", nargs='+', type=str, required=False, default=None, help="Shape of the pulse waveform ('monophasic' or 'biphasic'). If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--pulse_amplitude", nargs='+', type=float, required=False, default=None, help="Amplitude of the pulse waveform (1.0 or -1.0). If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--pulse_width", nargs='+', type=float, required=False, default=None, help="Width of the pulse waveform in ms. If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--cont_stim_freq", nargs='+', type=float, required=False, default=None, help="Frequency of the continuous stimulation waveform in Hz. If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--cont_stim_carrier_freq", nargs='+', type=float, required=False, default=None, help="Carrier frequency of the continuous stimulation waveform in Hz. If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--capacitive_stim_type", nargs='+', type=str, required=False, default=None, help="Type of capacitive stimulation ('flat-top' or 'exp-droop'). If provided, this should be the same number of values as the number of field files provided in --field_path.")
    parser.add_argument("--passive_end_nodes", action="store_true", default=None, help="Replace end nodes with passive segments in the axon models (no ion channels)")
