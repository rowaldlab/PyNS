...
: Abdallah Alashqar 
:
: Modification of channel properties for the tuned motor axon model
:
: Fast Na+, Persistant Na+, Slow K+, and Leakage currents 
: responsible for nodal action potential
: Iterative equations H-H notation rest = -79.5 mV
:
...
NEURON {
	SUFFIX axnode_motor_t
	NONSPECIFIC_CURRENT ina
	NONSPECIFIC_CURRENT inap
	NONSPECIFIC_CURRENT ik
	NONSPECIFIC_CURRENT il
	RANGE gnapbar, gnabar, gkbar, gl, ena, ek, el
	RANGE ampA, ampB, ampC, bmpA, bmpB, bmpC
	RANGE amA, amB, amC, bmA, bmB, bmC
	RANGE ahA, ahB, ahC, bhA, bhB, bhC
	RANGE asA, asB, asC, bsA, bsB, bsC
